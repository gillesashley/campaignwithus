...
export const SettingsProvider = props => {
  ...
  const [_settingsState, _updateSettingsState] = useState(() => {
    // Check if settingsCookie is not null or undefined and has essential properties to determine emptiness
    if (
      settingsCookie &&
      Object.keys(settingsCookie).length !== 0 &&
      settingsCookie.hasOwnProperty('settingsEnabled')
    ) {
